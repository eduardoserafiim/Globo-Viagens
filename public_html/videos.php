...
<head>
    ...
    <title>Relatos em vídeo | Painel Globo Viagens</title>
    ...
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            <header class="dashboard-top page-heading">
                <div><p class="eyebrow">Vozes de quem viajou</p><h1>Relatos em vídeo</h1><p class="page-intro">Adicione histórias reais dos passeios para inspirar quem está escolhendo o próximo destino.</p></div>
            </header>
