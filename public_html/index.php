...
<head>
    ...
    <meta name="description" content="Globo Viagens: hospedagens e destinos para criar viagens do seu jeito.">
    <title>Globo Viagens | Viaje do seu jeito</title>
    <link rel="icon" href="<?= asset('images/Logo.png') ?>"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Fraunces:opsz,wght@9..144,600;9..144,700&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css"><link rel="stylesheet" href="../private_html/styles/styles.css">
</head>
<body>
    <header class="site-header"><div class="shell header-inner">
        ...
        <nav class="main-nav" aria-label="Navegacao principal">
            ...
            <a href="#sobre">Sobre a Globo Viagens</a>
        </nav>
