...
<head>
    ...
    <title>Editar <?= htmlspecialchars($destino['nome']) ?> | Globo Viagens</title>
...
<body class="dashboard-body">
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main destination-create-page">
            ...
            <form class="destination-creation-layout" id="destinationEditForm" method="post" action="../private_html/controllers/destinoController.php" enctype="multipart/form-data">
