...
?>
<?php  getHeader('Criar destino | Painel', 'Cadastro de um novo destino.'); ?>
<body class="dashboard-body">
    <div class="dashboard-layout">
        <?php require_once __DIR__ . '/../../private_html/components/sidebar/sidebar.php'; renderSidebar('novo-destino'); ?>
        <main class="dashboard-main destination-create-page">
            <header class="dashboard-top page-heading"><div><a class="back-link dashboard-back-link" href="destinos"><i class="fa-solid fa-arrow-left"></i> Voltar para destinos</a><p class="eyebrow">Construa uma nova experiencia</p><h1>Criar destino</h1><p class="page-intro">Preencha os detalhes e acompanhe ao lado como a página ficará para seus viajantes.</p></div></header>
