...
?>
<?php  getHeader('Todos os destinos', 'Explore todos os destinos ativos da Globo Viagens.'); ?>
<body class="destinations-list-body">
    <header class="site-header detail-header"><div class="shell header-inner"><a class="brand" href="index" aria-label="Globo Viagens, inicio"><img src="<?= asset('images/Logo.png') ?>" alt="Globo Viagens"></a><nav class="main-nav" aria-label="Navegacao principal"><a href="index#destinos">Destinos</a><a href="index#relatos">Relatos</a><a href="index#sobre">A Globo</a></nav><a class="button button-dark" href="index"><i class="fa-solid fa-arrow-left"></i> Voltar ao inicio</a></div></header>
