...
$destinos = $autenticado ? listar_destinos(false) : [];
$perfil = perfil_admin();
$planos = [
...
$estatisticas = $autenticado ? estatisticas_destinos() : [
    'status' => ['total' => 0, 'ativos' => 0, 'inativos' => 0],
    'por_dia' => [],
    'por_mes' => [],
    'por_estado' => [],
];
...
<?php else: ?>
    <div class="dashboard-layout">
        <?php $pagina_painel = 'dashboard'; require __DIR__ . '/_sidebar.php'; ?>
        ...
        <main class="dashboard-main">
            <header class="dashboard-top" id="resumo">
                ...
                <a class="button button-dark" href="https://api.whatsapp.com/send?phone=67992027942" target="_blank" rel="noopener">Novo atendimento <span>+</span></a>
            </header>
